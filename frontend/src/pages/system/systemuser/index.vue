<template>
    <div>
        ...
        <div class="context-add"><a href="#">增添员工</a> </div>
        <div class="context">
            ...
            <ul>
                <li class="item" v-for="(item, index) in userlist">
                    ...
                    <div class="operation">
                        ...
                        <div><a href="#" @click="showUpdate(index)">编辑</a></div>
                        <div><a href="#">删除</a></div>
                    </div>
                </li>
            </ul>
        ...
        <div ref="update" class="update" :class="{ disappear: !showupdate }">
            ...
            <form action="" method="post" class="basic-grey">
                ...
                <label>
                    <span>民族 :</span>
                    <input id="ethnicity" type="text" name="ethnicity" />
                </label>
                <label>
                ...
                <label>
                    <span>政治面貌 :</span>
                    <input id="politicalFace" type="text" name="politicalFace" />
                </label>
                <label>
                    <span>文化程度 :</span>
        ...
        <div ref="add" class="add disappear">
            <form action="" method="post" class="basic-grey">
                <!-- <%--注意form title中的class就是下文提到的几种样式的名称，引入的时候要自己替换过来 --%> -->
                <h1>请填写以下信息</h1>
                <label>
